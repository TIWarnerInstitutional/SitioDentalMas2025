              ...
              <ul className="space-y-3">
                {services.map((service, index) => (
                  <motion.li 
                    ...
                    viewport={{ once: true }}
                  >
                    <a href="#" className="text-gray-300 hover:text-red-400 transition-colors flex items-center group">
              ...
              <ul className="space-y-3 mb-8">
                {quickLinks.map((link, index) => (
                  <motion.li 
                    ...
                    viewport={{ once: true }}
                  >
                    <a href={link.href} className="text-gray-300 hover:text-red-400 transition-colors group">
