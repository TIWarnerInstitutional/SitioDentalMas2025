"use client";
import { Phone, Mail, MapPin, Facebook, Instagram, Twitter, Linkedin, Clock, Award, Shield, Calendar } from "lucide-react";
                ...
                <div className="grid md:grid-cols-2 gap-8 items-center">
                  <div>
                    ...
                    <p className="text-gray-300 leading-relaxed">
                      Agenda tu cita hoy mismo y descubre por qué somos la clínica dental 
                      más confiable de la Ciudad de México.
                    </p>
                  </div>
                  <div className="space-y-4">
                    ...
                    <p className="text-gray-400 text-sm">
                      Recibe promociones exclusivas y consejos de salud dental
                    </p>
                  </div>
                </div>
              </div>
                  ...
                  <div className="lg:col-span-2 space-y-6">
                    <div>
                      ...
                      <p className="text-gray-300 leading-relaxed mb-6">
                        Transformando sonrisas desde 2012. Somos la clínica dental líder en México 
                        con tecnología de vanguardia y los mejores especialistas certificados 
                        internacionalmente.
                      </p>
                    </div>
                    <div className="space-y-4">
                      ...
                      <div className="flex space-x-3">
                        {[ 
                          ...
                          return (
                            ...
                            >
                              <a href="#" className="w-12 h-12 bg-gray-800 rounded-full flex items-center justify-center hover:bg-red-500 transition-all duration-300">
                                <Icon size={20} />
                              </a>
                            </motion.div>
                          );
                  ...
                  <div>
                    ...
                    <div>
                      ...
                      <ul className="space-y-2">
                        {["Términos y Condiciones", "Aviso de Privacidad", "Política de Cookies"].map((item, index) => (
                          <motion.li 
                            key={item}
                            initial={{ opacity: 0, x: -20 }}
                            whileInView={{ opacity: 1, x: 0 }}
                            ...
                            viewport={{ once: true }}
                          >
                            <div className="text-gray-400 hover:text-red-400 transition-colors text-sm">
                              {item}
                            </div>
                          </motion.li>
                        ))}
                    ...
                    <div className="space-y-6">
                      {locations.map((location, index) => (
                        <motion.div 
                          ...
                          viewport={{ once: true }}
                        >
                          <div className="space-y-2 p-3 bg-gray-800 rounded-lg hover:bg-gray-750 transition-colors">
